...
namespace CRUDExample.Controllers
{
  ...
  public class PersonsController : Controller
  {
    ...
    public async Task<IActionResult> Edit(PersonUpdateRequest personUpdateRequest)
    {
      ...
      if (ModelState.IsValid)
      {
        PersonResponse updatedPerson = await _personsService.UpdatePersonAsync(personUpdateRequest);
        return RedirectToAction("Index");
      }
      else
      {
    ...
    public async Task<IActionResult> Delete(PersonUpdateRequest personUpdateResult)
    {
      ...
      _personsService.DeletePersonAsync(personUpdateResult.PersonID);
      return RedirectToAction("Index");
    }
        [HttpGet("PersonsPDF")]
        public async Task<IActionResult> PersonsPDF()
        {
           List<PersonResponse> persons =await _personsService.GetAllPersonsAsync();
        ...
        [HttpGet("PersonsExcel")]
        public async Task<IActionResult> PersonsExcel()
        {
            MemoryStream memoryStream = await _personsService.GetPersonsExcelAsync();
